...
```{r,message=FALSE,fig.height=8,fig.width=6.5,results='asis',warning=FALSE}
...
part_plots <- lapply(levels(res[["nice_tex"]]), function(ith_condition) {
  filter(res, rna_type == "RNA2", mcra_type == "McrA3", feature_prop == 0.25,
         nice_tex == ith_condition) %>% 
